...
**Files:**
- Create: projeto Next.js na raiz `/Users/thiagotavares/Projects/a-labs/tech/komyx`
...
```bash
cd /Users/thiagotavares/Projects/a-labs/tech/komyx
  ...
  return (
    <main className="flex min-h-dvh items-center justify-center p-4">
      <form action={login} className="w-full max-w-sm space-y-4 rounded-[10px] border bg-card p-6">
        <h1 className="text-xl font-semibold">Entrar no Komyx</h1>
  ...
  return (
    <>
      ...
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-56 flex-col border-r bg-card p-4 md:flex">
        <p className="mb-6 text-lg font-bold">Komyx</p>
        {itens.map(({ href, label, icon: Icon }) => (
          <Link key={href} href={href}
...
export default async function OnboardingPage() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-xl font-semibold">Bem-vindo ao Komyx</h1>
...
- [ ] **Step 1: `src/app/layout.tsx`** — fonte Inter via `next/font/google`, `<html lang="pt-BR">`, metadata: title "Komyx — Chega de planilha para controlar suas comissões", description "Registre a venda. O Komyx calcula comissão, parcelas e mostra quanto você vai receber e quando.".
  ...
  return (
    <main className="mx-auto max-w-4xl px-4">
      <header className="flex items-center justify-between py-5">
        <span className="text-lg font-bold">Komyx</span>
      ...
      <section className="py-16 text-center">
        ...
        <p className="mx-auto mt-4 max-w-xl text-lg text-muted-foreground">
          ...
          o Komyx calcula comissão, parcelas e mostra exatamente quanto e quando você vai receber.
        </p>
